...
- **Crons** : **toujours désactivés**. #81 en attente de merge + run témoin 8 pour valider le calibrage. 403 nécessite soit un fix de logging (pour obtenir la preuve) soit directement un ticket Hostinger si le contexte suffit déjà à l'ouvrir.
