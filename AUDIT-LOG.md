...
- **(0b) Scan des 4 autres drafts en réserve pour les mêmes patterns de troncature** :
  ...
  - `48702` (transferts d'argent USA→Inde) : **1 troncature trouvée** -- "delivery within minutes to." dans l'encadré Quick Answer, destination manquante après "to". **Non corrigée, seulement signalée** (hors périmètre de la mission ciblée sur 48754).
