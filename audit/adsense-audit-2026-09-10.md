# Rapport d'audit AdSense — 2026-09-10
...
## Detail Phase 5 — Audit global (57 posts scannes)
```json
{
  "total_posts_scanned": 57,
  "weak_pages": [],
  "internal_leak_pages": [],
