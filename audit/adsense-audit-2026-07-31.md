# Rapport d'audit AdSense — 2026-07-31
...
## Detail Phase 5 — Audit global (54 posts scannes)
```json
{
  "total_posts_scanned": 54,
  "weak_pages": [],
  "internal_leak_pages": [],
...
- phase2 curl: HTTPSConnectionPool(host='moneyabroadguide.com', port=443): Read timed out. (read timeout=15)
